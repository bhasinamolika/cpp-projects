...
{
    fstream rd;
    rd.open("d:\\menu.txt",ios::in);//connect
...

{
    ...
    for(int i=1;i<=c;i++)
    {
        ...
        cout<<endl<<"********************************************************************************";
        cout<<endl<<"\t\t\t\t\tWelcome to My Food Place";
        cout<<endl<<"********************************************************************************";
        break;
    ...
    for(int j=1;j<=c;j++)
    {
        ...
        if(obj2.billno==n)
        {
            cout<<endl<<j<<"\t\t"<<setw(35)<<obj2.iname<<"\t"<<setw(4)<<obj2.price<<setw(3)<<obj2.qty<<setw(6)<<obj2.price<<setw(8)<<obj2.total;
...
{
    fstream rd;
    rd.open("d:\\bill.txt",ios::in);//connect
    rd.seekg(0,ios::end);//take cursor to end
    int bno;
    cout<<endl<<"Enter bill number";
    cin>>bno;
...
void raisebill()
{
    ...
    while(1)
    {
        ...
        fstream wr2;
        wr2.open("d:\\bill.txt",ios::app); // Writes object to bill file
...
main()
{
    ...
    while(e!=1)
    {
        ...
        cout<<endl<<"press 9 to search an itemcode from menu";
        cout<<endl<<"Press 5 to update Item from Menu";
        cout<<endl<<"Press 6 to Raise New Invoice";
        cout<<endl<<"Press 7 to reprint bill";
